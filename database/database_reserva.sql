...
('Juan Pérez', 'juan.perez@example.com', 'Chingado810', '555-1234', true),
('Ana Gómez', 'ana.gomez@example.com', 'Chingado820', '555-5678', true),
('Carlos Ruiz', 'carlos.ruiz@example.com', 'Chingado830', '555-9012', true),
('María Torres', 'maria.torres@example.com', 'Chingado840', '555-3456', false),
('Luis Martínez', 'luis.martinez@example.com', 'Chingado890', '555-7890', true),
('Pedro Sánchez', 'pedro.sanchez@example.com', 'Chingado850', '555-1235', true),
('Laura Fernández', 'laura.fernandez@example.com', 'Chingado860', '555-5679', true),
('Miguel Ramírez', 'miguel.ramirez@example.com', 'Chingado870', '555-9013', true),
('Sandra Pérez', 'sandra.perez@example.com', 'Chingado880', '555-3457', false),
('David Jiménez', 'david.jimenez@example.com', 'Chingado891', '555-7891', true),
('Marta González', 'marta.gonzalez@example.com', 'Chingado892', '555-1236', true),
('José López', 'jose.lopez@example.com', 'Chingado893', '555-5670', true),
('Lucía García', 'lucia.garcia@example.com', 'Chingado894', '555-9014', true),
('Raúl Fernández', 'raul.fernandez@example.com', 'Chingado895', '555-3458', false),
('Cristina Sánchez', 'cristina.sanchez@example.com', 'Chingado896', '555-7892', true),
('Antonio Martínez', 'antonio.martinez@example.com', 'Chingado897', '555-1237', true),
('Sofía Torres', 'sofia.torres@example.com', 'Chingado898', '555-5671', true),
('Pablo Ruiz', 'pablo.ruiz@example.com', 'Chingado899', '555-9015', true),
('Elena Ramírez', 'elena.ramirez@example.com', 'Chingado900', '555-3459', false),
('Andrés Jiménez', 'andres.jimenez@example.com', 'Chingado901', '555-7893', true);
